...
function adicionar6() {
    ...
    let novoItem6 = document.getElementById("nomeProduto6").innerHTML;
    novoArray6.push(novoItem6);
    let novoPreco6 = Number (document.querySelector("#valor6").innerHTML.slice(7));
    novoArray6.push(novoPreco6);
    let novaQuantidade6 = Number (document.querySelector("#quantidade6").value);
...
function adicionar8() {
    ...
    let novoItem8 = document.getElementById("nomeProduto7").innerHTML;
...
function adicionar10() {
    ...
    let novoPreco10 = Number (document.querySelector("#valor10").innerHTML.slice(7));
...
function adicionar11() {
    ...
    let novoPreco11 = Number (document.querySelector("#valor11").innerHTML.slice(7));
